...
import type { ExternalBlob as _ExternalBlob, Media as _Media, MediaType as _MediaType, Post as _Post, PostId as _PostId, Time as _Time, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createPost(arg0: string, arg1: Array<Media>): Promise<Post> {
        if (this.processError) {
            try {
    ...
    async updatePost(arg0: PostId, arg1: string, arg2: Array<Media>): Promise<Post> {
        if (this.processError) {
            try {
...
async function from_candid_Media_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Media): Promise<Media> {
...
async function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        media: await from_candid_vec_n18(_uploadFile, _downloadFile, value.media),
...
async function from_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Media>): Promise<Array<Media>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Media_n19(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_Media_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Media): Promise<_Media> {
...
async function to_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        mediaType: to_candid_MediaType_n14(_uploadFile, _downloadFile, value.mediaType)
    };
}
...
async function to_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<Media>): Promise<Array<_Media>> {
    return await Promise.all(value.map(async (x)=>await to_candid_Media_n11(_uploadFile, _downloadFile, x)));
}
